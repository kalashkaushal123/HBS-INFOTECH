...
import eye from '/src/features/services/services_pages/NearshoringServices/images/eye.svg'
// /src/features/services/services_pages/NearshoringServices/images

import tick from '/src/features/services/services_pages/NearshoringServices/images/tick.svg'
import lock from '/src/features/services/services_pages/NearshoringServices/images/lock.svg'
import face_recognition from '/src/features/services/services_pages/NearshoringServices/images/human verification.svg'
import upscale from '/src/features/services/services_pages/NearshoringServices/images/upscale.svg'
import cloud from '/src/features/services/services_pages/NearshoringServices/images/cloud.svg'
import text from '/src/features/services/services_pages/NearshoringServices/images/book.svg'
import analysis from '/src/features/services/services_pages/NearshoringServices/images/bulb ai.svg'

import  image1 from '/src/features/services/services_pages/NearshoringServices/images/1.webp'
import image2 from '/src/features/services/services_pages/NearshoringServices/images/2.webp'
import image3 from '/src/features/services/services_pages/NearshoringServices/images/3.svg'
import image4 from '/src/features/services/services_pages/NearshoringServices/images/4.svg'
import image5 from '/src/features/services/services_pages/NearshoringServices/images/5.webp'
import image6 from '/src/features/services/services_pages/NearshoringServices/images/6.svg'

import checkbox from '/src/features/services/services_pages/NearshoringServices/images/checkbox.svg'

import card1 from '/src/features/services/services_pages/NearshoringServices/images/card1.webp'
import card2 from '/src/features/services/services_pages/NearshoringServices/images/card2.webp'
import card3 from '/src/features/services/services_pages/NearshoringServices/images/card3.webp'
import card4 from '/src/features/services/services_pages/NearshoringServices/images/card4.webp'
import card5 from '/src/features/services/services_pages/NearshoringServices/images/card5.webp'
import card6 from '/src/features/services/services_pages/NearshoringServices/images/card6.webp'

export default function NearshoringServices() {
  return (
    <>
  <Header/>
 ...
 <div className="fluid" style={{backgroundColor:"white"}}>
      <div className="backgroundimg w-100" >
        ...
        <center className="m-auto mt-5 ">
          ...
          <svg className="rcicel" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none"><path d="M31.4434 32.4413V40.6221C31.4434 41.5347 30.6978 42.3332 29.7852 42.3332H12.8248C11.9122 42.3332 11.1667 41.5347 11.1667 40.6221V7.32465C11.1667 6.41206 11.9122 5.6665 12.8248 5.6665H29.7811C30.6937 5.6665 31.4393 6.41206 31.4393 7.32465V11.138" stroke="#FFFFFF" stroke-width="1.44" stroke-linecap="round" stroke-linejoin="round"></path><path d="M19.9257 38.6343H22.6838" stroke="#FFFFFF" stroke-width="1.44" stroke-linecap="round" stroke-linejoin="round"></path><path d="M24.6322 14.7235C23.9518 14.8987 23.3122 15.1635 22.7255 15.5098L20.5825 13.9902L18.6351 15.9376L20.1548 18.0805C19.8085 18.6631 19.5436 19.2987 19.3685 19.9709L16.7773 20.4109V23.165L19.3685 23.605C19.5436 24.2854 19.8125 24.925 20.1588 25.5117L18.631 27.6424L20.5785 29.5898L22.7092 28.062C23.2959 28.4124 23.9355 28.6813 24.6159 28.8524L25.0559 31.4435H27.814L28.254 28.8524C28.9303 28.6772 29.5699 28.4083 30.1607 28.062L32.2914 29.5898L34.2388 27.6424L32.711 25.5117C33.0614 24.9209 33.3344 24.2731 33.5055 23.5928L36.0925 23.165V20.4109L33.5055 19.9872C33.3344 19.3068 33.0655 18.6672 32.7192 18.0805L34.2388 15.9376L32.2914 13.9902L30.1485 15.5098C29.5618 15.1594 28.9181 14.8946 28.2418 14.7235L27.8181 12.1365H25.0599" stroke="#FFFFFF" stroke-width="1.44" stroke-linecap="round" stroke-linejoin="round"></path><path d="M25.7037 19.0662C25.9359 19.0051 26.1804 18.9725 26.433 18.9725C27.9933 18.9725 29.2563 20.2355 29.2563 21.7959C29.2563 23.3562 27.9933 24.6192 26.433 24.6192C24.8726 24.6192 23.6096 23.3562 23.6096 21.7959C23.6096 21.527 23.6463 21.2662 23.7155 21.0218" stroke="#FFFFFF" stroke-width="1.44" stroke-linecap="round" stroke-linejoin="round"></path></svg> 

          <div className="firNyj"> <h1 className="fRjBVq sm-header2">Nearshoring Services for the North American Market</h1></div>
          <div className="dwCooV cCEOnh sm-body20 m-auto">
          Ramp up development with cost-effective specialists who work in your time zone.
          </div>
