    ...
    <div className="fluid" style={{backgroundColor:"white"}}>
         <div className="backgroundimg w-100" >
           ...
           <center className="m-auto mt-5 ">
             ...
             Accelerate your digital transformation with embedded software services that deliver custom hardware development, testing, verification and consulting support.</div>
