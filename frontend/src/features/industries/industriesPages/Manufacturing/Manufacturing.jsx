   ...
   <div>
             ...
             <div>
               ...
               <div className="main-photo">
                 ...
                 <h1 className="main-heading">Manufacturing software development & consulting services</h1>
                 <p className="next-line">Enhance solutions, develop platforms and implement emerging technologies to deliver intuitive and secure products and services that accelerate your digital transformation.</p>
               ...
               <div className='auto'>
                     ...
                     <h2 style={{fontWeight:"bold", fontSize:'40px'}}>Manufacturing software development & consulting services</h2>
               ...
               <div className='container w-75'>
                     ...
                     <div className='col-md-6 d-flex mb-3'>
                           ...
                           <div  className='' style={{margin:"-3% 2rem 1rem"}}>
                             <h5 ><strong>
                             Customized development and consultancy for financial services</strong></h5>
