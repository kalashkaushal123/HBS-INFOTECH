   ...
   <div>
             ...
             <div>
               ...
               <div className="main-photo">
                 ...
                 <h1 className="main-heading">Telecom Software Development Services</h1>
                 <p className="next-line">Accelerate the digital transformation of your telecom applications with cloud-native architectures, DevOps tools, and advanced Gen AI technologies that streamline operations..</p>
               ...
               <div className='auto'>
                     ...
                     <h2 style={{fontWeight:"bold", fontSize:'40px'}}>Telecom Software Development Services</h2>
