     ...
     <div>
              ...
              <div>
                ...
                <div className="main-photo">
                  ...
                  <h1 className="main-heading">Biotechnology & Healthcare Software Development Solutions</h1>
                  <p className="next-line">Empower your organization with AI and digital tools to maximize the output of your R&D..</p>
                ...
                <div className='auto'>
                      ...
                      <h2 style={{fontWeight:"bold", fontSize:'40px'}}>Biotechnology & Healthcare Software Development Solutions</h2>
